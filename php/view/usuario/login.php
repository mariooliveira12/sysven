            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-5 d-none d-lg-block"><img src="../../img/wallpaper_login.jpg"/></div>
                            <!-- <div class="col-lg-5 d-none d-lg-block"><img src="https://fakeimg.pl/470x610/"/></div> -->
                            <div class="col-lg-7">
                                <div class="p-5">
                                <div class="text-center"><h1 class="h1 text-primary mb-5"><strong>Sysven</strong></h1></div>
                                    ...
                                    <form class="user" method='post' action='usuario.php'>
                                        ...
                                        <button type='submit' name='autenticar' class="btn btn-primary btn-user btn-block"><strong>Login</strong></button>  
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <a href="usuario.php?cadastro_form"><strong>Crie uma conta!</strong></a>
                                    </div>
                                </div>
                            </div>
                        </div>
